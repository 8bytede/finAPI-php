...
class BankConnection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets interfaces
     *
     * @param \OpenAPI\Client\Model\BankConnectionInterface[] $interfaces <strong>Type:</strong> BankConnectionInterface<br/> Set of interfaces that are connected for this bank connection.
     *
     * @return self
     */
     ...
     * Sets owners
     *
     * @param \OpenAPI\Client\Model\BankConnectionOwner[]|null $owners <strong>Type:</strong> BankConnectionOwner<br/> Information about the owner(s) of the bank connection
     *
     * @return self
     */
