...
class CreateDirectDebitParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets direct_debits
     *
     * @param \OpenAPI\Client\Model\DirectDebitOrderParams[] $direct_debits <strong>Type:</strong> DirectDebitOrderParams<br/> List of direct debit orders (may contain at most 15000 items). Please note that collective direct debit may not always be supported.
     *
     * @return self
     */
