...
class TrainCategorizationData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\TrainCategorizationTransactionData[] $transaction_data <strong>Type:</strong> TrainCategorizationTransactionData<br/> Set of transaction data (at most 100 transactions at once)
     *
     * @return self
     */
