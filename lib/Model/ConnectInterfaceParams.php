...
class ConnectInterfaceParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\LoginCredential[]|null $login_credentials <strong>Type:</strong> LoginCredential<br/> Set of login credentials. Must always be passed, unless the respective bank interface does not declare any login fields.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AccountReference[]|null $account_references <strong>Type:</strong> AccountReference<br/> List of accounts for which access is requested from the bank. It must only be passed if the bank interface has the DETAILED_CONSENT property set.
     *
     * @return self
     */
