...
class CreateMoneyTransferParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\MoneyTransferOrderParams[] $money_transfers <strong>Type:</strong> MoneyTransferOrderParams<br/> List of money transfer orders (may contain at most 15000 items). Please note that collective money transfer may not always be supported.
     *
     * @return self
     */
