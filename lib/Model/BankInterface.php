...
class BankInterface implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\BankInterfaceLoginField[] $login_credentials <strong>Type:</strong> BankInterfaceLoginField<br/> Login fields for this interface (in the order that we suggest to show them to the user)
     *
     * @return self
     */
