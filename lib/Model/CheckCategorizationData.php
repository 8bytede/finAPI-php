...
class CheckCategorizationData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\CheckCategorizationTransactionData[] $transaction_data <strong>Type:</strong> CheckCategorizationTransactionData<br/> Set of transaction data
     *
     * @return self
     */
