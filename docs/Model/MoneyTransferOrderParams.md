...
**end_to_end_id** | **string** | End-To-End ID for the transfer transaction. &lt;br/&gt;Only applicable for the SEPA EUR transfers and will be discarded for other transfers. | [optional]
